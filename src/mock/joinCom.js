...
export default {
  ...
  getList: config => {
    ...
    if (parseInt(page) === 1) {
      ...
      prevPageUrl = '/org/joinComList?sort=' + sort + '&page=' + (page - 1) + '&per_page=' + per_page + // eslint-disable-line
    ...
    if (parseInt(page) === lastPage) {
      ...
      nextPageUrl = '/org/joinComList?sort=' + sort + '&page=' + (page + 1) + '&per_page=' + nextPage + // eslint-disable-line
        '&filter=' + filter + '&type=' + type
    }
